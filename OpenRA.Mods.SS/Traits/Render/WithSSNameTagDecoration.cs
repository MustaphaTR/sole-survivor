...
namespace OpenRA.Mods.SS.Traits.Render
{
	[Desc("Displays the player name above the unit")]
	public class WithSSNameTagDecorationInfo : WithDecorationBaseInfo
	{
		...
		[Desc("Use the player color of the current owner, or the team leader.")]
		public readonly bool UsePlayerColor = false;

		public override object Create(ActorInitializer init) { return new WithSSNameTagDecoration(init.Self, this); }
